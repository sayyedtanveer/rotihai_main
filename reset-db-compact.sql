-- FAST DATABASE RESET WITH MASTER DATA
-- Copy & Paste this entire script into PostgreSQL
...
CREATE TABLE admin_users (id TEXT PRIMARY KEY, username TEXT UNIQUE NOT NULL, email TEXT UNIQUE NOT NULL, phone TEXT, password_hash TEXT NOT NULL, role admin_role DEFAULT 'manager', last_login_at TIMESTAMP, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
-- bcrypt hash: $2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36gZvWFm
...
-- Password for all: Chef@123
-- bcrypt hash: $2a$10$8N9RZhQu8D8yJ7x4k2kL5.vJ7c0K6m3N4o5P6q7R8s9T0u1V2w3X4
...
SELECT COUNT(*) as partner_users FROM partner_users;
