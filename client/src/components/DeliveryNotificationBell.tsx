...
export default function DeliveryNotificationBell({ wsConnected }: Props) {
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button
                        ...
                        data-testid="button-delivery-notifications"
                    >
                        ...
                        {unreadCount > 0 && (
                            <Badge
                                ...
                                data-testid="badge-delivery-notification-count"
                            >
                ...
                <DropdownMenuContent align="end" className="w-80 sm:w-96">
                    ...
                    <div className="flex items-center justify-between p-4 border-b">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-semibold text-sm">Delivery Alerts</h2>
                            {unreadCount > 0 && (
                    ...
                    {notifications.length > 0 ? (
                            ...
                            <div className="divide-y">
                                {notifications.map((notification) => (
                                    <div
                                        ...
                                        data-testid={`delivery-notification-${notification.id}`}
                                    >
                                        ...
                                        <div className="flex items-center justify-between mt-1">
                                            <Badge
                                                variant={notification.status === "ready" ? "default" : "outline"}
                                                className="text-xs"
                                            >
                                                {notification.status === "ready" ? "✅ Ready" : "🚚 Assigned"}
                                            </Badge>
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                            ...
                            <p className="text-sm font-medium">No delivery alerts</p>
                            <p className="text-xs mt-1 opacity-70">
                                {wsConnected ? "Listening for assignments..." : "Reconnecting..."}
                            </p>
                        </div>
                    )}
