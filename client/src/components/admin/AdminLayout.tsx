...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Pay Later Dues", href: "/admin/pay-later", icon: CreditCard },
      ...
      <div className="lg:flex">
        ...
        >
          ...
          <nav className="p-4 space-1 flex-1 overflow-y-auto">
            ...
            <Link href="/admin/delivery-areas">
              <div className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors cursor-pointer ${location === "/admin/delivery-areas" ? "bg-primary text-primary-foreground" : "text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"}`}>
