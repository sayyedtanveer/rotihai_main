...
const c = new Client({
  connectionString: 'postgresql://neondb_owner:npg_Jp2CY9PRTcDt@ep-lingering-sound-a8x9b6y8-pooler.eastus2.azure.neon.tech/rotihai_prod?sslmode=require&channel_binding=require'
});
c.connect()
